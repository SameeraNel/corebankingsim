...
public class CorebankingController {
    ...
    public ResponseEntity<Map<String, Object>> fundTransferViaSwitch(@RequestBody LedgerEntryRequestData request) {
    ...
    public ResponseEntity<Map<String, Object>> outwardTransferViaCdci(@RequestBody LedgerEntryRequestData request) {
        String fromAccount = request.getFromAccount();
        String toAccount = request.getToAccount();
        String merchantRefId = request.getMerchantRefId();
        String bankRefId = request.getBankRefId();
