...
public class CorebankingService {
  ...
  public String processSwitchOutwardTransfer(
      String fromAccount, String toAccount, String merchantRefId, String bankRefId) {
    ...
    while (elapsed < totalDelay) {
      ...
      elapsed += interval;
      logger.info(
          "Processing CEFT transfer {}... {} seconds elapsed",
          ceftrReferenceNumber,
          elapsed / 1000);
    }
  ...
  public String processCdciFundTransfer(
      String fromAccount, String toAccount, String merchantRefId, String bankRefId) {
